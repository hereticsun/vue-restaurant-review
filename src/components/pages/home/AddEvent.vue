        ...
        <fieldset>
          <ul>
            <li>
              ...
              <input name="eventdate" type="date" v-model="event.date" placeholder="DD/MM/YYYY" />
            </li>
            <li>
              <label for="eventvenue">Venue name:</label>
              <input name="eventvenue" type="text" placeholder="Venue name" v-model="event.venue" />
            </li>
            <li>
              <label for="eventaddress">Address:</label>
              <input name="eventaddress" type="text" placeholder="Venue address" v-model="event.address" />
            </li>
            <li>
              <label for="eventimage">Image URL:</label>
              <input name="eventimage" type="url" placeholder="Image URL" v-model="event.image" />
            </li>
            <li>
